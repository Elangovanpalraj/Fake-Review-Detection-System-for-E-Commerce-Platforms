...
with open(r'D:\new project titils and documentation pdf\Fake Review Detection System for E-Commerce Platforms\Fake-Review-Detector-main\scaling_pipeline.pkl', 'rb') as f:
    scaling_pipeline = pickle.load(f)

with open(r'D:\new project titils and documentation pdf\Fake Review Detection System for E-Commerce Platforms\Fake-Review-Detector-main\vectorization_pipeline.pkl', 'rb') as f:
    vectorization_pipeline = pickle.load(f)

review_classifier_model = joblib.load(r'D:\new project titils and documentation pdf\Fake Review Detection System for E-Commerce Platforms\Fake-Review-Detector-main\Review_classifier_LG.pkl')
